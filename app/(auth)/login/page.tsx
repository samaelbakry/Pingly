...
export default function LoginPage() {
  ...
  return (
    ...
    <div className="flex flex-col items-center text-center space-y-1.5 mb-6">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              className="w-full h-12 pl-10 pr-4 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-800/50 text-sm text-slate-800 dark:text-zinc-100 placeholder:text-slate-400 dark:placeholder:text-zinc-500 focus:border-orange-500 dark:focus:border-orange-500 focus:bg-white dark:focus:bg-zinc-800 focus:outline-none focus:ring-4 focus:ring-orange-500/10 transition-all"
              name="email"
        ...
        <button
          className="w-full h-12 mt-2 font-semibold bg-linear-to-r from-amber-500 via-orange-500 to-red-500 hover:opacity-95 text-white shadow-lg shadow-orange-500/20 dark:shadow-none transition-all active:scale-[0.99] rounded-xl cursor-pointer flex items-center justify-center gap-2 group disabled:opacity-50"
          type="submit"
          disabled={loading}
        >
          {loading ? (
      ...
      <p className="mt-6 text-center text-xs sm:text-sm font-medium text-slate-500 dark:text-zinc-400">
        Need an account?{" "}
        <Link
          href="/register"
