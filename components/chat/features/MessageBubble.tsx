            ...
            {isGroupChat ? (
              senderAvatar ? (
                <img
                  src={senderAvatar}
                  alt={senderName}
                  className="h-7 w-7 rounded-full object-cover ring-2 ring-zinc-200 dark:ring-zinc-800"
                />
              ) : (
                <div className="flex h-7 w-7 items-center justify-center rounded-full bg-orange-100 text-[11px] font-bold text-orange-600 dark:bg-orange-950/60 dark:text-orange-400 ring-2 ring-orange-200/50 dark:ring-orange-900/40">
        ...
        >
          {isGroupChat && !isMine && (
            <div className="mb-1 flex items-center gap-1.5 px-1">
              <span className="text-[11px] font-bold tracking-tight text-orange-600 dark:text-orange-400">
                {senderName}
              </span>
            </div>
          )}
